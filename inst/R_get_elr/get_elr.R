...
#####---------------------------------------------------------------------------
## solid incidence, lifetable, Walsh2019 model
#####---------------------------------------------------------------------------

rm_incid <- rm_solid_incid_walsh2019()
...
#####---------------------------------------------------------------------------
## solid incidence, mortality rate, Walsh2019 model
#####---------------------------------------------------------------------------
...
## single point estimate
get_elr(l_param=list(exposure      =list(dose=0.5, agex=20),
                     param_err     =rm_incid$err$param,
                     param_ear     =rm_incid$ear$param,
                     param_err_mort=rm_mort$err$param,
                     param_ear_mort=rm_mort$ear$param,
...
#####---------------------------------------------------------------------------
## breast incidence, lifetable, Walsh2019 model
#####---------------------------------------------------------------------------

rm_incid <- rm_breast_incid_walsh2019()
...
#####---------------------------------------------------------------------------
## leukemia incidence, lifetable, Walsh2019 model
#####---------------------------------------------------------------------------

rm_incid <- rm_leuk_incid_walsh2019()
...
## single point estimate
get_elr(l_param=list(exposure      =list(dose=0.5,
                                         agex=20),
                     param_err     =rm_incid$err$param,
                     param_ear     =rm_incid$ear$param,
                     param_err_mort=rm_mort$err$param,
...
## single point estimate
get_elr(l_param=list(exposure      =list(dose=c(0.5),
                                         agex=c(20)),
                     param_err     =rm_incid$err$param,
                     param_ear     =rm_incid$ear$param,
                     param_err_mort=rm_mort$err$param,
